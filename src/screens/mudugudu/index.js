    ...
    const navigation = useNavigation();
     return(
        <HomeWrapper title="Hello, John" navigation={()=>navigation.navigate('notification')}>
           ...
           <Text>Fasha abaturage uyobora kumenyekanisha imyirondoro yabo mu mudugudu batuyemo, ndetse no kumenyekanisha imyirondoro yabo mu mudugudu bimukiyemo</Text>
           <Text></Text>
           <View style={{
